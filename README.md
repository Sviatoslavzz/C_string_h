...
Implementation of the string.h library, sscanf and sprintf functions.

### my_string.h Types

| No. | Variable | Description |
| ------ | ------ | ------ |
| 1 | my_size_t | This is the unsigned integral type and is the result of the sizeof keyword. |

### my_string.h Macro

| No. | Macro | Description |
| ------ | ------ | ------ |
| 1 | MY_NULL | This macro is the value of a null pointer constant. |

### my_string.h Functions

| No. | Function | Description |
| ------ | ------ | ------ |
| 1 | void *my_memchr(const void *str, int c, my_size_t n) | Searches for the first occurrence of the character c (an unsigned char) in the first n bytes of the string pointed to, by the argument str. |
| 2 | int my_memcmp(const void *str1, const void *str2, my_size_t n) | Compares the first n bytes of str1 and str2. |
| 3 | void *my_memcpy(void *dest, const void *src, my_size_t n) | Copies n characters from src to dest. |
| 4 | void *my_memset(void *str, int c, my_size_t n) | Copies the character c (an unsigned char) to the first n characters of the string pointed to, by the argument str. |
| 5 | char *my_strncat(char *dest, const char *src, my_size_t n) | Appends the string pointed to, by src to the end of the string pointed to, by dest up to n characters long. |
| 6	| char *my_strchr(const char *str, int c) | Searches for the first occurrence of the character c (an unsigned char) in the string pointed to, by the argument str. |
| 7 | int my_strncmp(const char *str1, const char *str2, my_size_t n) | Compares at most the first n bytes of str1 and str2. |
| 8 | char *my_strncpy(char *dest, const char *src, my_size_t n) | Copies up to n characters from the string pointed to, by src to dest. |
| 9 | my_size_t strcspn(const char *str1, const char *str2) | Calculates the length of the initial segment of str1 which consists entirely of characters not in str2. |
| 10 | char *my_strerror(int errnum) | Searches an internal array for the error number errnum and returns a pointer to an error message string. You need to declare macros containing arrays of error messages for mac and linux operating systems. Error descriptions are available in the original library. Checking the current OS is carried out using directives. |
| 11 | my_size_t my_strlen(const char *str) | Computes the length of the string str up to but not including the terminating null character. |
| 12 | char *my_strpbrk(const char *str1, const char *str2) | Finds the first character in the string str1 that matches any character specified in str2. |
| 13 | char *my_strrchr(const char *str, int c) | Searches for the last occurrence of the character c (an unsigned char) in the string pointed to by the argument str. |
| 14 | char *my_strstr(const char *haystack, const char *needle) | Finds the first occurrence of the entire string needle (not including the terminating null character) which appears in the string haystack. |
| 15 | char *my_strtok(char *str, const char *delim) | Breaks string str into a series of tokens separated by delim. |

### my_sprintf and my_sscanf

- int my_sscanf(const char *str, const char *format, ...) - reads formatted input from a string;
- int my_sprintf(char *str, const char *format, ...) - sends formatted output to a string pointed to, by str.
...
### my_sprintf and my_sscanf *Width Description*
